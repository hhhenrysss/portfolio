...
import '../../../styles/stats_summary_widget.scss';
        ...
        return (
            <div className={'stats_summary_widget'}>
                ...
                <div className={'widget_info_wrapper'}>
                    ...
                    <i className="material-icons-outlined widget_icon" onClick={() => this.props.click_callback(this.props.id)}>{this.props.type}</i>
                </div>
            </div>
        );
    }
